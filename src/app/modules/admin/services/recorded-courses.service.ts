...
export class RecordedCoursesService {
  ...
  addRecordedCourse(formValue: any): Observable<any> {
    ...
    return this.http.post(`${this.domain}/admin/recordedCourses/add`, formData).pipe(catchError(this.handleError));
  }

  deleterecordedCourses(id: string): Observable<any> {
    return this.http.delete(`${this.domain}/admin/recordedCourses/${id}`).pipe(catchError(this.handleError));
  }

  getRecordedCourseById(id:string): Observable<any>{
    return this.http.get(`${this.domain}/admin/recordedCourses/${id}/details`).pipe(catchError(this.handleError));
  }
  ...
  updateRecordedCourse(id: string, formValue: any): Observable<any> {
    ...
    return this.http.patch(`${this.domain}/admin/recordedCourses/${id}`, formData).pipe(catchError(this.handleError));
  }
}
