...
export class AddCourseModalComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private course : CourseService, public dialog: MatDialog) {
    this.courseForm = this.fb.group({
      name: ['', [Validators.required, this.trimValidator]],
      level: ['', [Validators.required, this.levelValidator]],
      description:['', [Validators.required, this.trimValidator, Validators.minLength(10)]],
